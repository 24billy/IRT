                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a target="home">首頁</a></li>
                                <li><a target="develope.html">查詢作答結果</a></li>
                                <li><a target="about.html">新增帳號</a></li>
                                <li><a target="homework.html">前往CatSoFun</a></li>
                            </ul>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <i class="fa fa-fw fa-table"></i><span class="left10">查詢所有資料</span>
                                    <a class="btn btn-default btn-sm" data-toggle="collapse" data-parent="#listPanel" href="#recordPanel"><i class="fa fa-fw fa-bars"></i></a>
                                </h4>
                            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                ...
                                <a class="btn btn-default btn-sm" data-toggle="collapse" data-parent="#listPanel" href="#accountPanel"><i class="fa fa-fw fa-bars"></i></a>
                            </h4>
                        </div>
                        <div id="accountPanel" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form>
                                    <button>產生帳號密碼</button>
                                    <div>
