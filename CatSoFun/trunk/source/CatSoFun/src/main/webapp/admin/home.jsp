					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								...
								<a class="btn btn-default btn-sm toggleBtn" data-toggle="collapse"
									data-parent="#listPanel" href="#recordPanel"><i
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								...
								<a class="btn btn-default btn-sm toggleBtn" data-toggle="collapse"
									data-parent="#listPanel" href="#accountPanel"><i
									class="fa fa-fw fa-bars"></i></a>
							</h4>
						</div>
						<div id="accountPanel" class="panel-collapse collapse">
							<div class="panel-body">
								<form>
									...
									<div>
										<input><label>帳號</label> <input><label>密碼</label>
									</div>
									<div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="text-danger">
						<span id="idBlank">帳號</span> <span id="pwdBlank">密碼</span> 不得為空
					</h4>
				</div>
