...
INSERT INTO response(id,response_content,guild) VALUES (3,'{"answer":["從未如此","很少時間如此","某些時間如此","大部分時間如此","總是如此"]}','在過去四星期內,您在從事以下活動而感覺受限的情況有多頻繁…');
INSERT INTO response(id,response_content,guild) VALUES (4,'{"answer":["極不滿意","不滿意","中等程度滿意","滿意","極滿意"]}','我們的問題所關心的是您最近兩星期內的生活情形，請您用自己的標準、希望、愉快、以及關注點來回答問題。請參考下面的例題：');
INSERT INTO response(id,response_content,guild) VALUES (5,'{"answer":["完全沒有","有一點有","中等程度有","很有","極有"]}','我們的問題所關心的是您最近兩星期內的生活情形，請您用自己的標準、希望、愉快、以及關注點來回答問題。請參考下面的例題：');
INSERT INTO response(id,response_content,guild) VALUES (6,'{"answer":["完全沒有機會","少許機會","中等程度機會","很有機會","完全有機會"]}','我們的問題所關心的是您最近兩星期內的生活情形，請您用自己的標準、希望、愉快、以及關注點來回答問題。請參考下面的例題：');
INSERT INTO response(id,response_content,guild) VALUES (7,'{"answer":["從來沒有","很少","偶爾","常常","總是"]}','在過去一星期內‚您出現以下情況有多頻繁…');
